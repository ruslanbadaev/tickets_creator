          ...
          child: Column(
            ...
            children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      ...
                      if (recorder.isRecording) {
                        ...
                        pngBytes = await imageEx.toByteData(format: ui.ImageByteFormat.png);
                      }
              ...
              Container(
                ...
                decoration:
                    BoxDecoration(color: Colors.transparent, border: Border.all(color: Theme.of(context).primaryColor)),
                child: FittedBox(
                  child: SizedBox(
              ...
              Row(
                ...
                children: [
                  IconButton(
                    ...
                    color: selectedWidgetMarker == WidgetMarker.manual ? Theme.of(context).primaryColor : Colors.grey,
                  ),
                  IconButton(
                      onPressed: () {
...
class _ManualRemovalState extends State<ManualRemoval> {
  ...
  loadImage() async {
    canvas = Canvas(
        recorder, Rect.fromPoints(const Offset(0.0, 0.0), Offset(image!.width.toDouble(), image!.height.toDouble())));
...
class Sketcher extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < points.length - 1; i++) {
      ...
      canvas.drawCircle(points[i], brushSize ?? 15, paint);
    }
  }
}
